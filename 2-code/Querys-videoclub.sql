-- cantidad de peliculas clasificadas por rating
...
-- Cuantas películas hay de cada lengua
...
-- dinero generado por cada pelicula
...
-- dinero generado por cada actor
...
--  5 actores más alquilados por veces
